...
export const SERVER_UNREACHABLE_MESSAGE = 'The Macha server cannot be reached. Check that the server is running and that the API address below is correct.';
...
export function isGatewayConnectionFailure(response, bodyWasJson) {
