...
function PlaylistArtwork({ api, entry }) {
    ...
    return (_jsx("span", { className: "playlist-artwork", "aria-hidden": "true", children: artwork ? _jsx("img", { src: artwork, alt: "" }) : _jsx("span", { children: entry.track.title.slice(0, 1) }) }));
}
