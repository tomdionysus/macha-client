...
export function ArtistScreen({ api, artistId, onBack, onOpenAlbum }) {
    ...
    return (_jsxs("section", { className: "detail music-detail", children: [backdrop && _jsx("div", { className: "detail-backdrop", style: { backgroundImage: `url(${JSON.stringify(backdrop)})` } }), _jsxs("div", { className: "detail-content series-content", children: [_jsx("button", { className: "back-button", "data-tv-focusable": "true", onClick: onBack, type: "button", children: "\u2190 Music" }), _jsx("p", { className: "eyebrow", children: "Artist" }), _jsx("h1", { children: artist.title }), artist.synopsis && _jsx("p", { className: "synopsis", children: artist.synopsis }), _jsx(MediaRow, { api: api, title: "Albums", items: artist.albums, onOpen: onOpenAlbum })] })] }));
}
