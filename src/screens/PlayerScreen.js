    ...
    useEffect(() => {
        const onKeyDown = (keyEvent) => {
            ...
            if (presentation === 'full' && samsungBack) {
                ...
                if (controlsVisible || optionsVisible)
                    hideControls();
                else
                    onMinimize();
                return;
