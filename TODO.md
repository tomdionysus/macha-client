...
- Add the C++ playback resolver/streaming API behind the existing routable player page. The client must continue to prefer Direct Play, then Remux, then Transcode.
